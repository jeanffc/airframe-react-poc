            ...
            <CardBody>
              ...
              <Form>
                ...
                <FormGroup row>
                  ...
                  <Col sm={9}>
                    <Input type="select" name="select" id="defaultSelect">
                ...
                <FormGroup row>
                  ...
                  <Col sm={9}>
                    ...
                    <FormText color="muted">
                      ...
                      above input. Its a bit lighter and easily wraps to a new
                      line.
                    </FormText>
                  </Col>
                </FormGroup>
                    ...
                    <Row>
                      <Col sm={12} lg={4} className="mb-3 mb-md-0">
                        <Input
                          ...
                          placeholder=""
                        />
                        <FormText color="muted">Left Text Helper</FormText>
                      </Col>
                      <Col sm={12} lg={4} className="mb-3 mb-md-0">
                        <Input
                          type="text"
                  ...
                  <Col sm={9}>
                    <Row>
                      <Col sm={12} lg={4} className="mb-3 mb-md-0">
                        ...
                        />
                        <FormText>
                          <Badge color="primary">Left Badge Helper</Badge>
                        </FormText>
                      </Col>
                      <Col sm={12} lg={4} className="mb-3 mb-md-0">
                        <Input
                        ...
                        <FormText className="text-center">
                          <Badge color="success">Center Badge Helper</Badge>
                        </FormText>
                      </Col>
                      <Col sm={12} lg={4}>
                        <Input
                        ...
                        <FormText className="text-right">
                          <Badge color="warning">Right Badge Helper</Badge>
                        </FormText>
                      </Col>
                    </Row>
                  </Col>
                ...
                <FormGroup row>
                  ...
                  <Col sm={9}>
                    <Row>
                      ...
                      <Col sm={12} lg={4} className="mb-3 mb-md-0">
                        <Input type="select" name="select" id="defaultSize-2">
                  ...
                  <div className="mb-5">
                    ...
                    <Form>
                      <FormGroup>
                        ...
                        <FormGroup check>
                          <Label check>
                            <Input type="radio" name="radioStacked" /> Unchecked
                            Radio
                          </Label>
                        </FormGroup>
                        <FormGroup check disabled>
                  ...
                  <div>
                    ...
                    <Form>
                      <FormGroup>
                        ...
                        <FormGroup check inline>
                          <Label check>
                            <Input type="radio" name="radioInline" /> Unchecked
                          </Label>
                        </FormGroup>
                        <FormGroup check disabled inline>
                          <Label check>
